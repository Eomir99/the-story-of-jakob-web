...
export const MANIFEST = [
  ...
  { path: 'assets/backgrounds/utspring-staircase.webp' },
  { path: 'assets/backgrounds/utspring-polhem.webp' },
  ...
  { path: 'assets/backgrounds/clinic-mid.webp' },
  ...
  { path: 'assets/bosses/graduation-book.png' },
  { path: 'assets/bosses/graduation-scroll.png' },
  { path: 'assets/bosses/graduation-shockwave-1.png' },
  { path: 'assets/bosses/graduation-shockwave-2.png' },
  { path: 'assets/bosses/graduation-shockwave-3.png' },
  { path: 'assets/bosses/graduation-pillar-1.png' },
